        ...
        for month in months:
            ...
            for id in tqdm(ids):
                ...
                if response['hits']['total']['value']==0:
                    not_downs.append(id)
                # resp = doc.client.indices.clear_cache(index="arxiv_test2", fielddata=True)
            ...
            # # text_splitter = TokenTextSplitter(model_name="text-embedding-ada-002",chunk_size=250, chunk_overlap=0)
